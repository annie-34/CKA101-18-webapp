...
%>
<%-- debug: groupBuyVO null/productId output hidden for cleaner page --%>
<html>
<head>
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
<title>團購資料新增 - addGroupBuy.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>團購資料新增 - addGrupBuy.jsp</h3></td><td>
		 <h4><a href="<%=request.getContextPath()%>/farmer/select_page.jsp"><img src="images/tomcat.png" width="100" height="100" border="0">回首頁</a></h4>
	</td></tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>
            <select name="productId">
                <option value="">請選擇農產品</option>
                <c:forEach var="product" items="${productList}">
                    <option value="${product.productId}"
                        ${groupBuyVO.productId == product.productId ? "selected" : ""}>
                        ${product.productId}
                    </option>
                </c:forEach>
    ...
    <tr>
        ...
        <td>
            <input type="text" name="targetAmount"
                   value="${groupBuyVO.targetAmount}" size="45">
        </td>
    </tr>
    ...
    <tr>
        <td>團購單價:</td>
        <td>
            <input type="text" name="groupPrice"
                   value="${groupBuyVO.groupPrice}" size="45">
        </td>
    </tr>
    ...
    <tr>
        <td>開團時間:</td>
        <td>
            <input type="datetime-local" name="openDatetime">
        </td>
    </tr>
    ...
    <tr>
        <td>截止時間:</td>
        <td>
            <input type="datetime-local" name="ddlDatetime">
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" name="pickupAddress"
                   value="${groupBuyVO.pickupAddress}" size="45">
        </td>
    </tr>
