...
<%
GroupBuyVO groupBuyVO = (GroupBuyVO) request.getAttribute("groupBuyVO"); //EmpServlet.java(Concroller), 存入req的empVO物件
%>

<html>
<head>
<title>團購資料 - listOneGroupBuy.jsp</title>
...
<tr>
    <td><%=groupBuyVO.getGroupBuyId()%></td>
    <td><%=groupBuyVO.getProductId()%></td>
    <td><%=groupBuyVO.getHostUserId()%></td>
    <td><%=groupBuyVO.getTargetAmount()%></td>
    <td><%=groupBuyVO.getGroupPrice()%></td>
    <td><%=groupBuyVO.getOpenDatetime()%></td>
    <td><%=groupBuyVO.getDdlDatetime()%></td>
    <td><%=groupBuyVO.getStatus() == null ? "":groupBuyVO.getStatus().getDisplayName()%></td>
    <td><%=groupBuyVO.getCreatedAt()%></td>
    <td><%=groupBuyVO.getRequestStatus() == null ? "":groupBuyVO.getRequestStatus().getDisplayName()%></td>
    <td><%=groupBuyVO.getRequestDatetime()%></td>
    <td><%=groupBuyVO.getReplyDatetime()%></td>
    <td><%=groupBuyVO.getRejectReason()%></td>
    <td><%=groupBuyVO.getPickupAddress()%></td>
</tr>
</table>
